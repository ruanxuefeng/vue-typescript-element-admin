        ...
        <el-tabs @tab-remove="removeTab" type="border-card" v-model="activeTab">
            ...
            <el-tab-pane :closable='false' name="list">
                ...
                <el-table :data="data.list" border fit highlight-current-row v-loading="data.tableLoading">
                    ...
                    <el-table-column :align="data.commonAlign" label="corn表达式" prop="corn" width="300px"></el-table-column>
                    ...
                    <el-table-column :align="data.commonAlign" label="上次执行日期" prop="latestDate" width="200px"></el-table-column>
                    <el-table-column :align="data.commonAlign" label="执行耗时(秒)" prop="timeConsuming" width="100px"></el-table-column>
                    <el-table-column :align="data.commonAlign" label="创建人" prop="creatorName" width="100px"></el-table-column>
                    <el-table-column :align="data.commonAlign" label="创建时间" prop="createTime" width="200px"></el-table-column>
                    <el-table-column :align="data.commonAlign" label="最后更新人" prop="updaterName" width="100px"></el-table-column>
                    <el-table-column :align="data.commonAlign" label="最后更新时间" prop="updatedTime" width="200px"></el-table-column>
                    ...
                    <el-table-column :align="data.commonAlign" label="操作" min-width="300px">
                        <template slot-scope="scope">
                            <el-button-group>
                                ...
                                <el-button @click="handleUpdateStatus(scope.row)" :type="scope.row.status === 'Enable'?'danger':'success'">
            ...
            <el-tab-pane name="add" :closable='false'>
                ...
                <scheduled-task-form type="ADD" @handle-update="saveHandle"></scheduled-task-form>
            </el-tab-pane>
            <!--编辑tabs-->
            <el-tab-pane v-for="tab in tabs" :key="tab.name" :name="tab.name" closable>
                ...
                <scheduled-task-form :obj="tab.obj" type="UPDATE" @handle-update="updateHandle"></scheduled-task-form>
            </el-tab-pane>
        </el-tabs>
    </el-card>
</template>
...
<script lang="ts">
    ...
    import {list, save, update,updateStatus, trigger, del} from '@/views/scheduled-task/api';
