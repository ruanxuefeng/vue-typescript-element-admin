<template>
    <el-card shadow="hover">
        <el-form :inline="true">
            <el-form-item>
                <el-input v-model="query.name" placeholder="名称" clearable @keyup.enter.native="getList"></el-input>
            </el-form-item>
        ...
        <el-table v-loading="data.tableLoading" :data="data.list" border fit highlight-current-row>
            ...
            <el-table-column label="备注" prop="memo" width="450px" :align="data.commonAlign"></el-table-column>
...
<script lang="ts">
    ...
    import {list, save, update, del} from './api';
    import Data from '@/class/Data';
    import Query from './Query';
    import Obj from './BookType';
