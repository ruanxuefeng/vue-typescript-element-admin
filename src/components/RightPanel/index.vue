...
<script lang="ts">
    ...
    import {addClass, removeClass} from '@/uitils/index';

    @Component
    export default class RightPanel extends Vue {
        @Prop(Boolean)
        private clickNotClose: boolean = false;
        @Prop(Number)
        private buttonTop: number = 250;
        ...
        private closeSidebar(evt: any) {
            console.info(typeof evt);
